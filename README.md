...
**TDD project**  Implement a class with some methods using test-driven development (TDD), the class has the next methods:
...
- Go to this repo and copy the project link
        https://github.com/sambeck87/TDD_project
- Open your terminal and clone the repo with this command
```
git clone git@github.com:sambeck87/TDD_project.git
```
...
Feel free to check the [issues page](https://github.com/sambeck87/TDD_project/issues).
